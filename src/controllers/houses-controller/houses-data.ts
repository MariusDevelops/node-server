...
const houses: HouseModel[] = [
  {
    id: '1',
    title: 'Domek na drzewie wśród zwierząt',
    location: {
      country: 'Poland',
      city: 'Wychodne',
    },
  ...
  {
    id: '3',
    title: 'Gražus kaimiškas medinis rąstų namas Skriveri',
    location: {
      country: 'Latvija',
      city: 'Skrīveri',
    },
  ...
  {
    id: '7',
    title: 'Atostogų namai Elkos kalne',
    location: {
      country: 'Latvija',
      city: 'Skujene',
    },
  ...
  {
    id: '9',
    title: 'Unikalus poilsio namelis Elmau centre, 100 m nuo trobelės',
    location: {
      country: 'Austrija',
      city: 'Ellmau',
    },
  ...
  {
    id: '10',
    title: 'Gamtos rezidencija - Bondo slėnio gamtinis rezervatas',
    location: {
      country: 'Italija',
      city: 'Brescia',
    },
  ...
  {
    id: '11',
    title: 'Dangaus detalė, ramybė, gamta ir atsipalaidavimas',
    location: {
      country: 'Rumunija',
      city: 'Brașov County',
    },
  ...
  {
    id: '12',
    title: 'Alpių namelis su vaizdu į Aukštutinį Valė slėnį',
    location: {
      country: 'Šveicarija',
      city: 'Wallis',
    },
